"""
Compute daily returns and 30-day rolling annualised volatility for NTPC.

Outputs: plots/ntpc_daily_returns.png, plots/ntpc_volatility.png
"""
...
def main():
    """Compute daily returns and rolling volatility, save plots."""
